...
- **AI 작업자**: [`docs/ai/README.md`](./docs/ai/README.md) → 체크리스트/플레이북 확인 후 필요 시 [`AI_DEVELOPMENT_GUIDELINES.md`](./docs/guidelines/AI_DEVELOPMENT_GUIDELINES.md) 세부 규칙 검토 ⚠️
