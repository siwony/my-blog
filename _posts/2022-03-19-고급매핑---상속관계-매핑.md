...
- spring
- jpa
title: "[JPA] 고급매핑 - 상속관계 매핑"
description: "JPA에서 상속관계를 매핑하는 JOINED, SINGLE_TABLE, TABLE_PER_CLASS 전략 비교"
---
> JPA는 DB의 **슈퍼타입/서브타입** 과 같은 **어떠한 논리적 기법을 어떤 3가지 방법으로 매핑을 하던 모든 매핑을 지원한다.**
### 상속관계 매핑
: 객체의 상속과 구조와 DB의 슈퍼타입 서브타입 관계를 매핑하는것   
<img width=550px src="/assets/images/posts/jpa/inheritance-relationship-mapping.png">
...
<img width=500px src="/assets/images/posts/jpa/join-strategy.png">
...
<img width=500px src="/assets/images/posts/jpa/single-table-strategy.png">
...
<img width=600px src="/assets/images/posts/jpa/each-implements-class-table-strategy.png">
