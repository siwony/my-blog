...
tags:
- 유닛테스트
title: "[유닛테스트] 단위테스트 스타일"
description: "상태 기반, 출력 기반, 통신 기반 단위 테스트 스타일 비교와 장단점"
---
...
## 단위 테스트의 세 가지 스타일
### 1. 출력 기반 테스트
<img src="/assets/images/posts/book/output-based-test.jpeg">
...
### 2. 상태 기반 스타일 정의
<img src="/assets/images/posts/book/state-based-test.jpeg">
...
## 함수형 아키텍처
<img src="/assets/images/posts/book/functional-architecture.png">
