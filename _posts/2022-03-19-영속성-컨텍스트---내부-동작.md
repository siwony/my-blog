...
- spring
- jpa
title: "[JPA] 영속성 컨텍스트 - 내부 동작"
description: "JPA 영속성 컨텍스트의 1차 캐시, 더티 체킹, 쓰기 지연 등 내부 동작 원리 상세 설명"
---
> 영속성 컨텍스트는 JPA를 이해하는데 가장 중요하다.

### Entity ManagerFactory 와 EntityManager

<img width=500px src="/assets/images/posts/jpa/entity-manager-factory.png">
...
<img width=400px src="/assets/images/posts/jpa/not-persistence.png">
...
<img width=400px src="/assets/images/posts/jpa/managed.png">
...
<img align=center width=450px src="/assets/images/posts/jpa/1st-cash.png">
...
<img align=center width=450px src="/assets/images/posts/jpa/1st-cash-db.png">
...
<p float=left>
<img width=400px src="/assets/images/posts/jpa/persist-lazy.png>
<img width=400px src="/assets/images/posts/jpa/persist-lazy-commit.png">
</p>
...
<img width=450px src="/assets/images/posts/jpa/dirty-checking.png">
