...
- jpa
title: "[Jpa] Proxy"
description: "JPA에서 지연 로딩을 위해 사용하는 프록시 객체의 동작 원리"
---
### `em.find() vs em.getReference()`
- `em.find()` : DB를 통해서 실제 엔티티 객체 조회
- `em.getReference()` : DB 조회를 미루는 가짜(Proxy)엔티티 객체 조회  
  <img width=500px src="/assets/images/posts/jpa/em-get-reference.png">
...
member.getName();
```
<img width=500px src="/assets/images/posts/jpa/proxy-object-reset.png">
...
- 실제 객체의 참조(target)를 보관한다.  
  <img width=400px src="/assets/images/posts/jpa/proxy-delegate.png">  
