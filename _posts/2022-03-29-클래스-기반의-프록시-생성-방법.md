...
- 바이트코드-제어-방법
- java
title: "[Java] 클래스 기반의 프록시 생성 방법"
description: "ByteBuddy와 CGlib를 활용하여 클래스 기반 프록시를 생성하는 방법과 바이트코드 조작 기술"
---
...
이전 글 예제를 기반으로 작성 [이전글]({% post_url 2022-03-29-다이나믹-프록시---dynamic-proxy %})
## CGlib
