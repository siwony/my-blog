...
<img width=450px src="/assets/images/posts/spring/security/servlet-container.png">
...
<img width=550px src="/assets/images/posts/spring/security/spring-security-filter-chain.png">  
...
<img width=500px src="/assets/images/posts/spring/security/security-filter-chain-2.png">

**필터체인에는 다양한 필터들이 들어간다.**  
<img width=450px src="/assets/images/posts/spring/security/security-filters.png">
