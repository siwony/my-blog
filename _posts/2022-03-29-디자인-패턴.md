...
- java
title: "디자인 패턴"
description: "소프트웨어 설계에서 반복되는 문제를 효율적으로 해결하기 위한 디자인 패턴의 개념과 종류 (생성/구조/행위 패턴)"
---
...
#### 생성패턴의 종류
- [Singleton]({% post_url 2022-03-29-singleton-pattern %})
- Prototype
- Builder
- Abstract Factory
- Chaining
...
#### 구조패턴의 종류
- [Adapter]({% post_url 2022-03-29-adepter-pattern %})
- Composite
- Bridge
- [Decorator]({% post_url 2022-03-29-decorator-pattern %})
- Facade
- FlyWeight
- [Proxy]({% post_url 2022-03-29-proxy-pattern %})
...
- Interpreter
- Iterator
- [Observer]({% post_url 2022-03-29-observer-pattern %})
- [Strategy]({% post_url 2022-03-29-strategy-pattern전략-패턴 %})
- Visitor
