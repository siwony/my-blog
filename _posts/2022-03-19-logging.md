...
- spring
title: "Logging"
description: "애플리케이션 디버깅과 모니터링을 위한 로깅(Logging)의 개념과 중요성"
---
...
- [Logback]({% post_url 2022-03-19-logback %}) : log4j 개발자가 만든 log4j의 후속 버전, 현재 많은 프로젝트에서 사용됨 - 현제 SpringBoot의 기본 logging으로 사용하고있다.
