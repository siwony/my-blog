...
다음과 같이 문제 원인을 파악했다.  
파일명은 `뽀로로.psd` 와 같은 한국어와 영어가 섞인 문자열이다.
...
## 2026-02-03
서비스 운영 중 서비스 장애가 발생해서 대응 과정에서 이 마운트 옵션을 끼워넣었다.
해결된 것으로 보였으나 여전히 발생하고 있다.
