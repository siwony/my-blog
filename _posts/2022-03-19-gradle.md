...
- build-tool
title: "Gradle"
description: "Groovy 기반 빌드 자동화 도구 Gradle의 특징과 설정 방법"
---
> Java 진영에서 사용하는 [Build Tool]({% post_url 2022-03-19-build-tool %})이다.
...
- Maven, lvy등 기존 저장소 인프라 또는 `pom.xml` 파일과 `ivy.xml` 파일에 대한 migration의 편이성 제공
    > 참고. [maven to gradle migration]({% post_url 2022-03-19-springboot-maven-to-gradle-build-tool-migration %})
- 멀티 프로젝트 Build를 지원한다.
