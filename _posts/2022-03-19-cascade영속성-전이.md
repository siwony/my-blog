...
description: "JPA에서 엔터티 간 영속성 상태를 전이하는 Cascade 옵션"
---
# CASCADE(영속성 전이)
...
<img width=450px src="/assets/images/posts/jpa/cascade.png">

- 단일 엔티티에 종속적일 때 사용한다. &rarr; 단일 소유자
- 엔티티 생명주기가 거의 유사할떄 사용한다.
### CASCADE 저장
`@OneToMany(mappedBy="parent", cascade=CascadeType.PERSIST)`  
<img width=450px src="/assets/images/posts/jpa/cascade-save.png">
