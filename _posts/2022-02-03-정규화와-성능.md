...
- data-modeling
- sqld
title: "[SQLD] 3-1 정규화와 성능"
description: "데이터베이스 정규화의 각 단계와 성능 트레이드오프"
---
## 1. 정규화 - Normalization
...
이전글: [데이터 모델과 성능]({% post_url 2022-02-03-데이터-모델과-성능 %})
다음글: [반정규화]({% post_url 2022-02-14-반정규화-denormalization %})
